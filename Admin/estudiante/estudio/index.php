...
<body>
    ...
    <div class="general conteiner-fluid d-flex">
        ...
        <?php require_once $_SERVER['DOCUMENT_ROOT'] . '/insttic.com/admin/estudiante/components/aside.php' ?>

        <?php require_once $_SERVER['DOCUMENT_ROOT'] . '/insttic.com/admin/estudiante/components/asideResponsive.php' ?>
        ...
        <div class="container mt-4 d-flex justify-content-center ">
            ...
            <div class="row container gap-1 d-flex justify-content-around">
                <div class="col-12 col-lg-10 caja_dash">
        ...
        <div class="container">
            <div class="row mt-4 d-flex justify-content-center">
                <p class="h4 text-center" style="color: #0A2A66;">PLAN DE ESTUDIO</p>
                <div class="tabla col-lg-12 col-12 mt-3 d-flex justify-content-center flex-column">
                    ...
                    <a href="./horarios/horario.xlsx" download="horario.xlsx" class="btn" style="background-color: #0A2A66; color: #ffffff;">
                        Descargar horario
